# Copilot Instructions for az-scout-plugin-avs-rvtools-analyser
...
└── static/
    ├── css/
    │   └── avs-rvtools-analyser.css      # Plugin styles (auto-loaded via css_entry)
    ├── html/
    │   └── avs-rvtools-analyser-tab.html # HTML fragment (fetched by JS at runtime)
    └── js/
        └── avs-rvtools-analyser-tab.js   # Tab UI logic (auto-loaded via js_entry)
```
...
avs_rvtools_analyser = "az_scout_avs_rvtools_analyser:plugin"
```
